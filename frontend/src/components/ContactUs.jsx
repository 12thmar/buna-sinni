      ...
      <section id="contact-form" className="mx-auto max-w-7xl px-4 py-10">
        <div className="grid gap-10 md:grid-cols-2">
          ...
          <div className="space-y-6">
            <div className="rounded-xl border border-neutral-200 p-4 text-sm text-neutral-600 bg-white">
              Prefer email? We typically respond within 1–2 business days.
            </div>

            <div className="rounded-2xl bg-[color:var(--coffee-soft,#faf7f4)] p-6 space-y-4 border border-black/10">
              <ContactCard
                title="Phone"
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-3xl border border-black/10 bg-white p-6 shadow-sm">
              ...
              <p className="mt-4 text-xs text-black/45">
                Tip: For wholesale quotes, include expected monthly volume and your preferred roast level.
              </p>
            </div>
          </div>
        </div>
